...
public class RobotTemplateMessageHolder2 extends MessageHolderBase implements SobotLabelsView.OnLabelClickListener, View.OnClickListener {
    ...
    public RobotTemplateMessageHolder2(Context context, View convertView) {
        ...
        mContext = context;
        tv_msg = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template2_msg"));
        tv_more = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_tv_more"));
        slv_labels = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template2_labels"));
