...
public class RobotTemplateMessageHolder3 extends MessageHolderBase implements View.OnClickListener {
    ...
    public RobotTemplateMessageHolder3(Context context, View convertView) {
        ...
        mContext = context;
        sobot_msg = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template3_msg"));
        sobot_template3_layout = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template3_layout"));
        tv_more = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_tv_more"));
                ...
                if (interfaceRetList != null && interfaceRetList.size() > 0) {
                    ...
                    for (int i = 0; i < getDisplayNum(multiDiaRespInfo, interfaceRetList.size()); i++) {
                        ...
                        if (interfaceRet != null && interfaceRet.size() > 0) {
                            ...
                            LinearLayout sobot_template3_anchor = view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template3_anchor"));
                            ImageView sobot_template3_thumbrail = view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template3_thumbrail"));
                            TextView sobot_template3_title = view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template3_title"));
                            TextView sobot_template3_summary = view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template3_summary"));
                            TextView sobot_template3_tag = view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template3_tag"));
