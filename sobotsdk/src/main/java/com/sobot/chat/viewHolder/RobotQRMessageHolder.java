...
public class RobotQRMessageHolder extends MessageHolderBase {
    ...
    public RobotQRMessageHolder(Context context, View convertView) {
        ...
        tv_title = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_msg"));
    ...
    public static class QuestionRecommendViewHolder implements OnClickListener {
        ...
        private QuestionRecommendViewHolder(Context context, View convertView,SobotMsgAdapter.SobotMsgCallBack msgCallBack) {
            ...
            sobotLayout = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template1_item"));
            sobotThumbnail = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_item_thumbnail"));
            sobotTitle = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_item_title"));
        }
