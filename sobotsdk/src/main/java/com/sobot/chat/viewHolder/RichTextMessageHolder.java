...
public class RichTextMessageHolder extends MessageHolderBase {
    ...
    public RichTextMessageHolder(Context context, View convertView){
        ...
        sobot_rl_real_pic = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_rl_real_pic"));
        isGif = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_pic_isgif"));
        sobot_real_ll_content = convertView.findViewById(ResourceUtils.getIdByName(context,"id","sobot_real_ll_content"));
        imgHead = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_imgHead"));
        name = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_name"));
        msg = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_msg"));
        sobot_msg_title = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_msg_title"));
        read_alltext_line = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "read_alltext_line"));

        // 纯图片的信息
        simple_picture = convertView
                .findViewById(ResourceUtils.getIdByName(context, "id",
                        "sobot_simple_picture"));

        // 富文本的大图片
        bigPicImage = convertView
                .findViewById(ResourceUtils.getIdByName(context, "id",
                        "sobot_bigPicImage"));
        // 阅读全文
        rendAllText = convertView
                .findViewById(ResourceUtils.getIdByName(context, "id",
                        "sobot_rendAllText"));


        stripe = convertView.findViewById(ResourceUtils
        ...
        sobot_tv_transferBtn = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_tv_transferBtn"));
        sobot_tv_likeBtn = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_tv_likeBtn"));
        sobot_tv_dislikeBtn = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_tv_dislikeBtn"));
    }
