...
public class RobotTemplateMessageHolder5 extends MessageHolderBase {
    ...
    public RobotTemplateMessageHolder5(Context context, View convertView) {
        ...
        sobot_template5_msg = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template5_msg"));
        sobot_template5_title = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template5_title"));
    }
