...
public class RobotTemplateMessageHolder4 extends MessageHolderBase {
    ...
    public RobotTemplateMessageHolder4(Context context, View convertView) {
        ...
        sobot_template4_thumbnail = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template4_thumbnail"));
        sobot_template4_title = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template4_title"));
        sobot_template4_summary = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template4_summary"));
        sobot_template4_anchor = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template4_anchor"));
    }
