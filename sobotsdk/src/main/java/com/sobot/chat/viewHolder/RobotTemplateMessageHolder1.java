...
public class RobotTemplateMessageHolder1 extends MessageHolderBase {
    ...
    public RobotTemplateMessageHolder1(Context context, View convertView) {
        ...
        tv_title = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot__template1_msg"));
        sobot_horizontal_scrollview_layout = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template1_horizontal_scrollview_layout"));
        sobot_horizontal_scrollview = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template1_horizontal_scrollview"));
    }
        ...
        if (message.getAnswer() != null && message.getAnswer().getMultiDiaRespInfo() != null) {
            ...
            if ("000000".equals(multiDiaRespInfo.getRetCode()) && interfaceRetList != null && interfaceRetList.size() > 0) {
                ...
                for (int i = 0; i < interfaceRetList.size(); i++) {
                    ...
                    Template1ViewHolder viewHolder;
                    if (i < childCount) {
    ...
    public static class Template1ViewHolder implements OnClickListener{
        ...
        public Template1ViewHolder(Context context, View convertView, SobotMsgAdapter.SobotMsgCallBack msgCallBack) {
            sobotLayout = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template1_item_"));
            sobotThumbnail = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template1_item_thumbnail"));
            sobotTitle = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template1_item_title"));
            sobotSummary = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template1_item_summary"));
            sobotLable = convertView.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_template1_item_lable"));
