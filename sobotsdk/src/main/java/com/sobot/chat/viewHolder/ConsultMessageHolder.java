...
public class ConsultMessageHolder extends MessageHolderBase {
    ...
    public ConsultMessageHolder(Context context, View convertView) {
        ...
        btn_sendBtn = convertView.findViewById(ResourceUtils.getIdByName(context, "id",
                "sobot_goods_sendBtn"));
        iv_pic = convertView.findViewById(ResourceUtils.getIdByName(context, "id",
                "sobot_goods_pic"));
        tv_title = convertView.findViewById(ResourceUtils.getIdByName(context, "id",
                "sobot_goods_title"));
        tv_describe = convertView.findViewById(ResourceUtils.getIdByName(context, "id",
                "sobot_goods_describe"));
        tv_lable = convertView.findViewById(ResourceUtils.getIdByName(context, "id",
                "sobot_goods_label"));
    }
