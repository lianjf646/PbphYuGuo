...
public abstract class MessageHolderBase {
    ...
    public MessageHolderBase(Context context, View convertView) {
        reminde_time_Text = convertView.findViewById(ResourceUtils.getIdByName(context, "id","sobot_reminde_time_Text"));
        ...
        frameLayout = convertView.findViewById(ResourceUtils.getIdByName(context, "id","sobot_frame_layout"));
        msgProgressBar = convertView.findViewById(ResourceUtils.getIdByName(context, "id","sobot_msgProgressBar"));// 重新发送的进度条信息
        // 消息的状态
        msgStatus = convertView.findViewById(ResourceUtils.getIdByName(context, "id","sobot_msgStatus"));
    }
    ...
    public static void showReSendDialog(Context context,final ImageView msgStatus,final ReSendListener reSendListener ){
        ...
        if(reSendDialog.getWindow()!= null){
            ...
            lp.width = display.getWidth() - widths; // 设置宽度
