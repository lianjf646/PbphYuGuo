...
public class SobotSikllAdapter extends SobotBaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        sobot_ll_skill = convertView.findViewById(ResourceUtils
                .getIdByName(context, "id", "sobot_ll_skill"));
        sobot_tv_skill_name = convertView.findViewById(ResourceUtils
                .getIdByName(context, "id", "sobot_tv_skill_name"));
        sobot_tv_status = convertView.findViewById(ResourceUtils
