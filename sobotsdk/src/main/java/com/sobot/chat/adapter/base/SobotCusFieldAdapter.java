...
public class SobotCusFieldAdapter extends SobotBaseAdapter<SobotCusFieldDataInfo> {
    ...
    class MyViewHolder{
        ...
        MyViewHolder(View view){
            categorySmallTitle = view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_activity_cusfield_listview_items_title"));
            categorySmallIshave = view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_activity_cusfield_listview_items_ishave"));
            categorySmallCheckBox = view.findViewById(ResourceUtils.getIdByName(context, "id", "sobot_activity_cusfield_listview_items_checkbox"));
