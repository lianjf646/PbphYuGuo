...
public class SobotPostCategoryAdapter extends SobotBaseAdapter<SobotTypeModel> {
    ...
    static class ViewHolder{
        ...
        ViewHolder(Context context,View view){
            categoryTitle = view.findViewById(ResourceUtils.getIdByName(context, "id", "work_order_category_title"));
            categoryIshave = view.findViewById(ResourceUtils.getIdByName(context, "id", "work_order_category_ishave"));
