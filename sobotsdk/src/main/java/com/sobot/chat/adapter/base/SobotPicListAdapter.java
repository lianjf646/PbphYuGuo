...
public class SobotPicListAdapter extends SobotBaseAdapter<ZhiChiUploadAppFileModelResult> {
    ...
    private static class SobotFileHolder {
        ...
        SobotFileHolder(Context context,View convertView) {
            ...
            sobot_iv_pic = convertView.findViewById(ResourceUtils.getIdByName(context, "id","sobot_iv_pic"));
            sobot_iv_pic_add = convertView.findViewById(ResourceUtils.getIdByName(context, "id","sobot_iv_pic_add"));
        }
