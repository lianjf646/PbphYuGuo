...
public class ReSendDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button = findViewById(ResourceUtils.getIdByName(content, "id", "sobot_negativeButton"));
		button2 = findViewById(ResourceUtils.getIdByName(content, "id", "sobot_positiveButton"));
