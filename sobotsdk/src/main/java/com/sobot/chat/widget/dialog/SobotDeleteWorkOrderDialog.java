...
public class SobotDeleteWorkOrderDialog extends Dialog {
    ...
    private void initView(){
        tv_photo_hint = findViewById(ResourceUtils.getIdByName(getContext(), "id", "tv_photo_hint"));
        btn_pick_photo = findViewById(ResourceUtils.getIdByName(getContext(), "id", "btn_pick_photo"));
        btn_cancel = findViewById(ResourceUtils.getIdByName(getContext(), "id", "btn_cancel"));
        coustom_pop_layout = findViewById(ResourceUtils.getIdByName(getContext(), "id", "pop_layout"));
