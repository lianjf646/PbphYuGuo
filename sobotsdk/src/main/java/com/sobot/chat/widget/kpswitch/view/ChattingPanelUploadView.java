...
public class ChattingPanelUploadView extends BaseChattingPanelView implements View.OnClickListener {
    ...
    public void initData() {
        sobot_custom_bottom = getRootView().findViewById(getResId("sobot_custom_bottom"));
        sobot_robot_bottom = getRootView().findViewById(getResId("sobot_robot_bottom"));
        sobot_btn_picture = getRootView().findViewById(getResId("sobot_btn_picture"));
        sobot_btn_take_picture = getRootView().findViewById(getResId("sobot_btn_take_picture"));
        sobot_btn_satisfaction = getRootView().findViewById(getResId("sobot_btn_satisfaction"));
        sobot_robot_btn_leavemsg = getRootView().findViewById(getResId("sobot_robot_btn_leavemsg"));
        sobot_robot_btn_satisfaction = getRootView().findViewById(getResId("sobot_robot_btn_satisfaction"));
