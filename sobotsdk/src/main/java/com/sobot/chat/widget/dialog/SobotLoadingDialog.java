...
public class SobotLoadingDialog extends Dialog {
    ...
    public static SobotLoadingDialog createDialog(Context context, String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            TextView textView = customProgressDialog.findViewById(ResourceUtils.getIdByName(context, "id", "id_tv_loadingmsg"));
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ImageView imageView = findViewById(ResourceUtils.getIdByName(getContext(), "id", "loadingImageView"));
