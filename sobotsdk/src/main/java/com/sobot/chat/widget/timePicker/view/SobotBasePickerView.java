...
public class SobotBasePickerView {
    ...
    protected void initViews(int backgroudId) {
        ...
        if (isDialog()) {
            ...
            //这个是真正要加载时间选取器的父布局
            contentContainer = dialogView.findViewById(ResourceUtils.getIdByName(context,"id","content_container"));
            //设置对话框 左右间距屏幕30
            ...
            //这个是真正要加载时间选取器的父布局
            contentContainer = rootView.findViewById(ResourceUtils.getIdByName(context,"id","content_container"));
