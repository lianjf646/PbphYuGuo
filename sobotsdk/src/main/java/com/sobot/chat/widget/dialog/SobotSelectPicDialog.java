...
public class SobotSelectPicDialog  extends Dialog {
    ...
    private void initView() {
        btn_take_photo = findViewById(ResourceUtils.getIdByName(context, "id","btn_take_photo"));
        btn_pick_photo = findViewById(ResourceUtils.getIdByName(context, "id","btn_pick_photo"));
        btn_cancel = findViewById(ResourceUtils.getIdByName(context, "id","btn_cancel"));
        coustom_pop_layout = findViewById(ResourceUtils.getIdByName(context, "id","pop_layout"));
