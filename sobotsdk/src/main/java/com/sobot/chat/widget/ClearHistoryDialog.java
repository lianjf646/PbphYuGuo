...
public class ClearHistoryDialog extends Dialog implements View.OnClickListener {
    ...
    private void initView() {
        sobot_btn_take_photo = findViewById(ResourceUtils.getIdByName(getContext(), "id",
                "sobot_btn_take_photo"));
        sobot_btn_cancel = findViewById(ResourceUtils.getIdByName(getContext(), "id",
                "sobot_btn_cancel"));
        sobot_pop_layout = findViewById(ResourceUtils.getIdByName(getContext(), "id",
                "sobot_pop_layout"));
