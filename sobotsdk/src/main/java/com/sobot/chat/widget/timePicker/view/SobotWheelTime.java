...
public class SobotWheelTime {
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        currentYear = year;
        // 年
        wv_year = view.findViewById(ResourceUtils.getIdByName(view.getContext(),"id","year"));
        ...
        // 月
        wv_month = view.findViewById(ResourceUtils.getIdByName(view.getContext(),"id","month"));
     ...
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/
        ...
        // 日
        wv_day = view.findViewById(ResourceUtils.getIdByName(view.getContext(),"id","day"));
       ...
       /* wv_day.setLabel(context.getString(R.string.pickerview_day));*/
        ...
        //时
        wv_hours = view.findViewById(ResourceUtils.getIdByName(view.getContext(),"id","hour"));
        wv_hours.setAdapter(new SobotNumericWheelAdapter(0, 23));
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);
        //分
        wv_mins = view.findViewById(ResourceUtils.getIdByName(view.getContext(),"id","min"));
        wv_mins.setAdapter(new SobotNumericWheelAdapter(0, 59));
       /* wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字*/
        wv_mins.setCurrentItem(m);
        wv_mins.setGravity(gravity);
        //秒
        wv_seconds = view.findViewById(ResourceUtils.getIdByName(view.getContext(),"id","second"));
