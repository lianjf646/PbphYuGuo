...
public class WebViewActivity extends SobotBaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mWebView = findViewById(getResId("sobot_mWebView"));
        mProgressBar = findViewById(getResId("sobot_loadProgress"));
        sobot_rl_net_error = findViewById(getResId("sobot_rl_net_error"));
        sobot_webview_toolsbar = findViewById(getResId("sobot_webview_toolsbar"));
        sobot_btn_reconnect = findViewById(getResId("sobot_btn_reconnect"));
        sobot_btn_reconnect.setOnClickListener(this);
        sobot_txt_loading = findViewById(getResId("sobot_txt_loading"));
        sobot_webview_goback = findViewById(getResId("sobot_webview_goback"));
        sobot_webview_forward = findViewById(getResId("sobot_webview_forward"));
        sobot_webview_reload = findViewById(getResId("sobot_webview_reload"));
        sobot_webview_copy = findViewById(getResId("sobot_webview_copy"));
