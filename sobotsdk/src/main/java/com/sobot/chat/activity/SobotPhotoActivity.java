...
public class SobotPhotoActivity extends Activity implements View.OnLongClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		big_photo = findViewById(ResourceUtils.getIdByName(this,
				"id", "sobot_big_photo"));
		sobot_image_view = findViewById(ResourceUtils.getIdByName(
				this, "id", "sobot_image_view"));
		sobot_rl_gif = findViewById(ResourceUtils.getIdByName(
