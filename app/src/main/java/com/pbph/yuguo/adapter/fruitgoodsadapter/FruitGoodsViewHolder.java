...
public class FruitGoodsViewHolder extends ViewHolder<GetGoodsListResponse.DataBean.GoodsCategoryListBean.CategoryGoodsListBean> {
...
//        tvAdapterGoodsListDiscountPrice.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG); //中划线
    ...
    private final OnSPClickListener listener = new OnSPClickListener() {
        ...
        public void onClickSucc(View v) {
            ...
            adapter.onItemViewClickListener.onItemViewClick(v.getId(), FruitGoodsViewHolder.this);
        }
    };
