 ...
 */
public class VipDayAdapter extends BaseAdapter {

    private List<GetMemberDayActivityGoodsResponse.DataBean.ResultListBean> listBean;
    ...
    public VipDayAdapter(OnItemViewClickListener onItemViewClickListener) {
        this.onItemViewClickListener = onItemViewClickListener;
    }

    public void setStringList(List<GetMemberDayActivityGoodsResponse.DataBean.ResultListBean> listBean) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_vip_day_list_more, null);
        ...
        GetMemberDayActivityGoodsResponse.DataBean.ResultListBean goodsListBean = listBean.get(position);
        ...
        viewHolder.tvOriginalPrice.append(MoneyHelper.getInstance4Fen(goodsListBean.getGoodsSalePrice()).change2Yuan()
                .getString());
        viewHolder.tvName.setText(goodsListBean.getMemberDayActivityName());
...
//        viewHolder.tvOriginalPrice.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG | Paint.ANTI_ALIAS_FLAG);
    ...
    public interface OnItemViewClickListener {
        void onItemViewClick(GetMemberDayActivityGoodsResponse.DataBean.ResultListBean goodsListBean, int pos);
    }
