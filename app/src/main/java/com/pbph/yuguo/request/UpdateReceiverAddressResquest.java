...
public class UpdateReceiverAddressResquest extends BaseRequest {
    //  地址id
    Integer addressId;
    //	用户id
    String customerId;
    ...
    public UpdateReceiverAddressResquest(Integer addressId,String customerId, String receiverName,
                                         String
            receiverPhone, String receiverCity, String receiverAddressDetail, String defaultFlag,
                                         String
                                                 receiverLat, String receiverLng, String
                                                 receiverVillage) {
