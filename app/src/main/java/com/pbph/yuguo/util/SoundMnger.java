...
public final class SoundMnger {
    ...
    public static SoundMnger getInstance() {
        return SoundMnger.InnerInstance.INSTANCE;
    }
    ...
    public SoundMnger init() {
        return this.init(1);
    }

    public SoundMnger init(int size) {
    ...
    public void load2Play(Context context, int rawId) {
        load(context, rawId);
        playByRawId(rawId);
    }

    public synchronized void load(Context context, int rawId) {
    ...
    public synchronized void playBySoundId(Integer soundId) {
        SoundInfo info = soundid_info_map.get(soundId);
    ...
    public void unloadByRawId(Integer rawId) {
        Integer soundId = rawid_soundid_map.get(rawId);
        unloadBySoundId(soundId);
    }

    public void unloadBySoundId(Integer soundId) {
