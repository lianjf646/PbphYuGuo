...
public abstract class ABaseTransformer implements PageTransformer {
	...
	/**
	 * Indicates if the default_photo animations of the view pager should be used.
	 *
	 * @return
	 */
	 ...
	 * <p>
	 * The default_photo implementation attempts to reset all view properties. This is useful when toggling transforms that do
